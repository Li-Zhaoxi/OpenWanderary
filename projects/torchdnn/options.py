...
class Options:
    ...
    def parse(self):
        ...
        parser.add_argument('--resultroot', type=str, required=True, help='result save root')
        ...
        self.task = args.task
        self.fold = args.fold
        self.root_dir = args.dataroot
        self.result_dir = args.resultroot
        ...
        print('model parms: ', self.model)
        print('train parms: ', self.train)
        print('test parms: ', self.test)
        print('transform parms: ', self.transform)
        # exit()
